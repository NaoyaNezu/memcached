...
struct item_ecc{
	...
	int k_size;
	int v_size;
	struct ecc_prms* m_bch;
	struct ecc_prms* k_bch;
	struct ecc_prms* v_bch;
};
//*----------------------------------------------------------------------------------------------------*
#endif
...
#ifdef FI
#include "fault_inject.h" //nezu added
#endif
...
#ifdef SOFT_ECC // nezu add----------------------------------------------------------------------------------------
extern int incr_refcount(item* it);
extern int decr_refcount(item* it);
#define refcount_incr(it) incr_refcount(it)
#define refcount_decr(it) decr_refcount(it)
#else
...
#ifdef SOFT_ECC//for ecc nezu add-----------------------------------------------------------------------------*
extern struct item_ecc* set_ecc(item * it);
extern void check_ecc(item* it);
extern struct item_ecc* make_item_ecc(item *it);
extern void update_ecc(item* it,bool do_m,bool do_k, bool do_v);
extern void free_ecc(item* it);
//*----------------------------------------------------------------------------------------------------------*
#endif
